...
const Home = () => {
    return (
        <div loading="lazy" decoding="async" className="min-h-screen bg-[url('/img/bg1.webp')] md:bg-[url('/img/bg.jpg')] overflow-hidden object-fill bg-cover bg-center bg-fixed">
            <Hero />
            <About />
            <Service />
            <Portfolio />
